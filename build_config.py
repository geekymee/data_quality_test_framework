...
# =============================================================================
# STATIC INFRASTRUCTURE — edit here when infra changes, never prompted
# =============================================================================
...
# ── Config writer — always writes the full file from scratch ──────────────────
...
def write_config(not_null_single, not_null_composite, no_duplicates,
    ...
    sections = [
        ...
        "",
        f"SETTINGS = {_repr_dict(SETTINGS)}",
        "",
        "# =============================================================================",
...
def main():
    print("=" * 60)
    print("  DE Test Framework - Test Definition Builder")
    print("=" * 60)
